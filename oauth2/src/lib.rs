//! # pimalaya-oauth2
//!
//! This crate provides helpers to simplify OAuth2 flows.
//!
//! For now it only exposes an [`AuthorizationCodeGrant`] builder,
//! which helps to complete the OAuth2 [authorization code grant]
//! flow.
//!
//! ```rust,ignore
...
/// OAuth2 Authorization Code Grant flow builder.
///
